...
export const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen w-full bg-[#f7f8f4] flex items-center justify-center p-4 md:p-8 font-sans antialiased selection:bg-[#0b281a] selection:text-white">
      {/* Outer Card Container */}
      <div className="w-full max-w-[1200px] bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200/60 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[680px]">
        {/* Left Form Container */}
        <div className="lg:col-span-6 p-6 sm:p-12 md:p-14 flex flex-col justify-between max-w-[540px] mx-auto w-full">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-2xl bg-[#0b281a] flex items-center justify-center text-emerald-400 shadow-md shadow-[#0b281a]/20">
        ...
        <div className="hidden lg:block lg:col-span-6 p-4">
          <div className="w-full h-full relative rounded-3xl overflow-hidden shadow-inner bg-[#0b281a] flex flex-col justify-between p-10">
            {/* Background Image */}
            <img
              src="/auth_hero.png"
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#061d12] via-[#0b281a]/60 to-transparent"></div>
